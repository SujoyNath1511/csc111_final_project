...
def run_game_pygame(white: Player, black: Player) -> tuple[str, list]:
    ...
    size = (800, 800)
    allow = [pygame.MOUSEBUTTONDOWN, pygame.MOUSEBUTTONUP, pygame.quit()]
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and self.clicked != '':
                ...
                if self.released != '':
                    ...
                    if move in game.get_valid_moves():
                        ...
                        rect = pygame.Rect((OFFSET + x * RECT_SIZE, OFFSET + y * RECT_SIZE),
                                           (RECT_SIZE, RECT_SIZE))
                        pygame.draw.rect(game.screen, (84, 84, 84), rect, width=0)
